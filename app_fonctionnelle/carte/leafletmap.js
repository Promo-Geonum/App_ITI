...
var routeFeature = function (feature, layer) {
	var popup_content = ""
	popup_content += '<p>Cette partie du trajet fait <b>' + Math.round(feature.properties.distance * 100000) + ' km</b></p>'
	layer.bindPopup(popup_content)
}
...
var overlayMaps = {
	...
	"Vélo Tout-Terrain<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/VTT.png'></span>": VTT,
	"Domaine skiable<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/SKI.png'></span>": SKI,
	"Boucle de randonnée<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/RANDO.png'></span>": RANDO,
	"Sports nautiques<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/NAUT.png'></span>": NAUT,
	"Natation<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/NATA.png'></span> 	": NATA,
	"Terrains extérieurs<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/TERREXT.png'></span>": TERREXT,
	"Skatepark<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/SKATE.png'></span>": SKATE,
	"Patinoire<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/GLACE.png'></span>": GLACE,
	"Équitation<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/EQU.png'></span>": EQU,
	"Parcours sportif<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/PARC.png'></span>": PARC,
	"Golf<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/GOLF.png'></span>": GOLF,
	"Boulodrome<span class='layers-control-img'><img class= 'layers-control-img' src='../img/picto_sport/BOUL.png'></span>": BOUL
};

//Creation and settings of the map
var mymap = L.map('mapid', {
	layers: [TOUT], zoomSnap: 0.01})
.fitBounds([[dep_coords[1], dep_coords[0]], [arr_coords[1], arr_coords[0]]], {padding: [100, 100]});
...
function getRoute(un, deux) {
	...
	if (un == source_id) {
		$.getJSON(url, function(data) {
			...
			distance1 = Math.round(data.features[0].properties.distance * 100000)
		...
		$.getJSON(url, function(data) {
			...
			mymap.addLayer(pathLayer);
			distance2 = Math.round(data.features[0].properties.distance * 100000)
			info.update(distance1, distance2)
	})
	}
}
...
etape_marker = new L.circleMarker([etape.geometry.coordinates[1], etape.geometry.coordinates[0]], {radius : 20, color: 'green', fill: false}).addTo(mymap)
